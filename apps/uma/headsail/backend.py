...
# under the License.
"""UMA backend for the headsail accelerator"""
from passes import HeadsailConv2dPass, ConvertLayout
...
from patterns import qnn_conv2d_pattern, qnn_conv2d_bias_relu_pattern, qnn_conv2d_add_pattern
from strategies import qnn_conv2d_strategy


class HeadsailBackend(UMABackend):
    """UMA backend for the Headsail accelerator."""
    ...
    def __init__(self):
        ...
        self._register_pattern("qnn_conv2d", qnn_conv2d_add_pattern())
        ...
        self._register_tir_pass(PassPhase.TIR_PHASE_0, HeadsailConv2dPass())
