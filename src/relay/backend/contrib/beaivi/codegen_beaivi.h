 ...
 */
#ifndef TVM_RELAY_BACKEND_CONTRIB_BEAIVI_CODEGEN_C_H_
#define TVM_RELAY_BACKEND_CONTRIB_BEAIVI_CODEGEN_C_H_
...
class BeaiviCodegenCBase {
 public:
  virtual ~BeaiviCodegenCBase() {}
 ...
 * a \p CSourceModule.
 */
transform::Pass BeaiviCompilerPass();

}  // namespace contrib
}  // namespace relay
}  // namespace tvm

#endif  // TVM_RELAY_BACKEND_CONTRIB_BEAIVI_CODEGEN_C_H_
